...
const UserInfoPool = () => {
    ...
    //     contract_BnbForBnb: BNBForBNB(environment?.UserInfoPoolBNBForBNB, web3),
    //     contract_BnbForToken: BNBForToken(environment?.UserInfoPoolBNBForToken, web3),
    //     contract_TokenForBnb: TokenForBNB(environment?.UserInfoPoolTokenForBNB, web3),
    //     contract_TokenForToken: TokenForToken(environment?.UserInfoPoolTokenForToken, web3),
    // }
    const userInfoo = useCallback(
    ...
    return { userInfoo: userInfoo };
};

export default UserInfoPool;
